...
def index():
    if request.method == "POST":
        ...
        # Extract the balance query parameter from the URL
        balance = request.args.get('balance', default='0')  # Default to '0' if not provided
        ...
        # Passing the balance value to the template
        return render_template('index.html', selected_recommendations=selected_recommendations, rec_fd=rec_fd, balance=balance)

    return render_template('index.html', selected_recommendations=[], rec_fd=[], balance='0')
